...
public class TaxDaoStabImpl implements TaxDao {
    private Map<String, Tax> taxes = new HashMap<>();

    public static String TAX_FILE = "TestFolder/Taxes_test.txt";
    public static final String DELIMITER = ",";

    public TaxDaoStabImpl() throws FlooringPersistenceException {
        loadTaxes();
    }

    //for testing
//    public TaxDaoStubImpl(String taxFile) throws FlooringPersistenceException{
//        TAX_FILE = taxFile;
//        loadTaxes();
//    }
